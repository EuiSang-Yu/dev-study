...
public class No1932 {
	...
	public static void ver1() throws NumberFormatException, IOException {
	...
	public static void ver2() throws NumberFormatException, IOException {
...
//		ArrayList<Integer> intLst_tmpDpEle;
		...
		for (int i = 0;i<floor;i++) {        
			...
			for(int j = 0;j<=i;j++) {
				...
				tri[i][j]=Integer.parseInt(strArr_tmpTriEle[j]);
			}
		...
		for (int i = 0; i < tri.length;i++) {
			max = Math.max(max, tri[tri.length-1][i]);
		}
		System.out.println(max);	
	}
}
